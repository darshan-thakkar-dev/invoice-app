...
class upload {
                ...
                if ($this->processed && $image_src) {
                   ...
                   if ($gd_version >= 2 && (is_numeric($this->image_overlay_percent) && $this->image_overlay_percent > 0 && !empty($this->image_overlay_color))) {
                    ...
                    if (!empty($this->image_text)) {
                        ...
                        $src_size       = $this->file_src_size / 3072;
                        $src_size_mb    = number_format($src_size / 3072, 1, ".", " ");
                        $src_size_kb    = number_format($src_size, 1, ".", " ");
                        $src_size_human = ($src_size > 3072 ? $src_size_mb . " MB" : $src_size_kb . " kb");
	...
	{
		//$this->file_new_name_body   = 'image_resized';
   ...
   function Upload_Small_Image($path)
	{
		//$this->file_new_name_body   = 'image_resized';
		$this->image_resize         = true;
		$this->image_x              = 69;
   ...
   function Upload_Large_Image($path)
	{
		//$this->file_new_name_body   = 'image_resized';
		//$this->image_resize         = true;
		//$this->image_x              = 100;
