...
fclose($file);
	...
	include("includes/config.php");
    	...
    	if (empty($company_name)) {
			...
			$query_class_duplicate=$con->select_query("tbl_sup","*","Where company_name='".$company_name."'");
    		...
    		$insertUser = $con->insert_record("tbl_sup",$supplier);
					// $user_id = mysqli_insert_id();
					//print_r($userid);die();
					header('Content-type: application/json');
					echo json_encode(array("status"=>1,"message"=>"Supplier added Successfully."));
    	}
    }
?>